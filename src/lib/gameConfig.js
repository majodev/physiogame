  ...
  function(Backbone, _, gameConfigMap,
    ...
    var GameConfig = Backbone.Model.extend({
      ...
      defaults: {
        ...
        crosshairTexture: gameConfigMap.crosshairTexture.def,
        crosshairTextureRotate: gameConfigMap.crosshairTextureRotate.def,
        ...
        leapLocksMouseAndTouchForMs: gameConfigMap.leapLocksMouseAndTouchForMs.def,
        leapButtonHitAfterMs: gameConfigMap.leapButtonHitAfterMs.def,
        leapSpecialsHitAfterMs: gameConfigMap.leapSpecialsHitAfterMs.def,
        leapXModifier: gameConfigMap.leapXModifier.def,
        leapYModifier: gameConfigMap.leapYModifier.def,
        leapZModifier: gameConfigMap.leapZModifier.def,
